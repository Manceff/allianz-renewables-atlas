        ...
        <a class="atlas-link" href="https://github.com/Manceff/allianz-renewables-atlas"
          ...
          <svg viewBox="0 0 16 16" width="13" height="13" aria-hidden="true">
            <path fill="currentColor" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38
              0-.19-.01-.82-.01-1.49-2 .37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53
          ...
          <span>github.com/Manceff/allianz-renewables-atlas</span>
        </a>
      </div>
    </div>
    """,
...
# Persist selection across reruns. Also support ?park=<id> deep links so a
# specific park can be opened directly from a URL (useful for sharing and
# for documentation screenshots).
if clicked_park_id:
    st.session_state["selected_park_id"] = clicked_park_id
elif "selected_park_id" not in st.session_state:
    qp_park = st.query_params.get("park")
    if qp_park and any(p["id"] == qp_park for p in globe_parks):
        st.session_state["selected_park_id"] = qp_park
